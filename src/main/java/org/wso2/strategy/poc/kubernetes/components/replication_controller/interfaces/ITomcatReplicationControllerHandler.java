...
*/
package org.wso2.strategy.poc.kubernetes.components.replication_controller.interfaces;
...
public interface ITomcatReplicationControllerHandler {
     ...
     * @throws WebArtifactHandlerException
     */
    ReplicationController deleteReplicationController(String controllerName) throws WebArtifactHandlerException;
}
