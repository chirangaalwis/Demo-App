...
*/
package org.wso2.strategy.poc.docker;
...
/**
 * a Java class which implements IDockerContainerHandler Java interface
 */
public class JavaDockerContainerHandler implements IDockerContainerHandler {
    private final DockerClient dockerClient;
    private static final int OPERATION_DELAY_IN_MILLISECONDS = 2000;
    private static final Logger LOG = LogManager.getLogger(JavaDockerContainerHandler.class);

    public JavaDockerContainerHandler(String dockerEndpointURI) {
