...
public class TomcatPodHandler implements ITomcatPodHandler {
    ...
    public void deletePod(String podName) throws WebArtifactHandlerException {
        try {
            ...
            if(LOG.isDebugEnabled()) {
                LOG.debug(String.format("Deleting Kubernetes pod [pod-name] %s",
                        podName));
            }
            ...
            if(LOG.isDebugEnabled()) {
                LOG.debug(String.format("Deleted Kubernetes pod [pod-name] %s",
                        podName));
            }
     ...
     * @param podBaseName       replica pods' base name
     * @throws WebArtifactHandlerException
     */
